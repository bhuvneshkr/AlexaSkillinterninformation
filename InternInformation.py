...
class InternInformationHandler(AbstractRequestHandler):
    """Handler for Hello World Intent."""
    def can_handle(self, handler_input):
        # type: (HandlerInput) -> bool
        return ask_utils.is_intent_name("InternInformation")(handler_input)
    ...
    def handle(self, handler_input):
        ...
        speak_output = "Thanks, " + ". Your start date is " + data['Item']['start']['S'] + "Want to know more about team. You are part of " + data['Item']['team']['S']

        
        #speak_output = 'Thanks, {name}.'.format(name=name)
